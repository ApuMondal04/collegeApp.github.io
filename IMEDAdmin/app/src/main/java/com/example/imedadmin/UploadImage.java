...
import com.example.imedadmin.faculty.UpdateTeacherActivity;
...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items=new String[]{"Select Category","Convocation","Independence day","Teachers Day","Xpression","C-Googly","Others Events"};
        ...
        uploadTask.addOnCompleteListener(UploadImage.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(UploadImage.this, "Something went to wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
