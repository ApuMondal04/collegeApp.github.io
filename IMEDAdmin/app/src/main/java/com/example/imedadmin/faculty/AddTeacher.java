...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items=new String[]{"Select Category","BCA","BBA","MCA","MBA"};
    ...
    private void insertData()
    {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                pd.dismiss();
                Toast.makeText(AddTeacher.this, "Faculty Data Uploaded", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddTeacher.this, "Something went to wrong!", Toast.LENGTH_SHORT).show();
            }
        });
    }
